...
document.querySelectorAll('.btn, .btn-signup').forEach(button => {
    button.addEventListener('click', createRipple);
});

// Smooth scroll reveal for sections
const revealSections = document.querySelectorAll('.hero, .about, .menu, .blog, .contact');
